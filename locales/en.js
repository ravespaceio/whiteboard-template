{
	...
	"support": "RaveBoard Support",
	"offline": "Offline. Click for more.",
	"error": "Sorry, but something went wrong. Please contact support@RaveBoard.com",
	"welcome": "Welcome",
	...
	"name": "Name",
	"confirm_subject": "RaveBoard Email Confirmation",
	"confirm_body": "Thank you for signing up at RaveBoard.\nPlease click on the following link to confirm your email address.\n",
	"confirm_action": "Confirm Now",
	"team_invite_membership_subject": "Team Invitation for %s",
	"team_invite_membership_body": "You have been invited to %s on RaveBoard. Please click on the following link to accept the invitation.",
	"team_invite_user_body": "You have been invited to %s on RaveBoard.\nYour temporary password is \"%s\".\nPlease click on the following link to accept the invitation.",
	...
	"team_new_member_body": "%s just joined Team %s on RaveBoard.",
	"space_invite_membership_subject": "%s invited you to a Space %s ",
	"space_invite_membership_body": "You have been invited by %s to join a Space %s on RaveBoard. Please click on the following link to accept the invitation.",
	"space_invite_membership_action": "Accept",
	"folder_invite_membership_subject": "Space",
	"folder_invite_membership_body": "You have been invited to a Team on RaveBoard. Please click on the following link to accept the invitation.",
	...
	"RaveBoard_pro_ad_folders": "With RaveBoard Pro, you can organize an unlimited amount of Spaces in Folders and manage access controls for each Folder. Would you like to learn more about Pro features?",
	"RaveBoard_pro_ad_versions": "With RaveBoard Pro, you can save unlimited versions of each Space to track your progress or keep snapshots safe. Would you like to learn more about Pro features?",
	"RaveBoard_pro_ad_pdf": "With RaveBoard Pro, you can export your Spaces as crisp PDFs for archiving, mailing around, or printing. Do you want to learn more about Pro features?",
	"RaveBoard_pro_ad_zip": "With RaveBoard Pro, you can export the contents of a Space as a ZIP package. Do you want to learn more about Pro features?",
	"RaveBoard_pro_ad_colors": "With RaveBoard Pro, you can mix your own colors using a professional color picker.",
	...
	"landing_claim": "RaveBoard lets you easily combine all kinds of media on virtual whiteboards: Text notes, photos, web links, even videos and audio recordings. ",
	"landing_example": "People use RaveBoard to organize their ideas, in teams to see whole projects at a glance, or in schools and universities for richer, connected learning experiences.",
	"spaces": "My Spaces",
	...
	"landing_features_text": "The new RaveBoard 5 has a streamlined, beautiful user interface that makes your work easier and more fun than ever before – while giving you even more powerful features:",
	...
	"welcome_subject": "Welcome to RaveBoard",
	"welcome_body": "Hello!\nThank you for signing up at RaveBoard.<br>We hope you will enjoy working in Spaces.<br>Remember, your account includes unlimited collaborators. Feel free to share your Spaces with friends and colleagues all over the world.",
	...
	"pro_ad_history_headline": "When you upgrade to RaveBoard Pro, you will see a history of recent updates across all your (shared) Spaces here.",
	"password_reset_subject": "Reset Password for RaveBoard",
	"password_reset_body": "You requested a reset of your RaveBoard password.\nPlease click on the following link to set a new password.",
	"password_reset_action": "Reset Now",
	"was_offline": "The connection to RaveBoard was interrupted. If you have unsaved work, please keep this browser tab open until the connection is re-established, then touch the unsaved objects again.",
	"subscription_failed_user_subject": "Problem with your RaveBoard Payment",
	...
	"subscription_failed_team_subject": "Problem with your RaveBoard Payment",
