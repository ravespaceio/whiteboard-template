{
	...
	"support": "white[ ]space Support",
	"offline": "Offline. Click for more.",
	"error": "Sorry, but something went wrong. Please contact support@white[ ]space.com",
	"welcome": "Welcome",
	...
	"name": "Name",
	"confirm_subject": "white[ ]space Email Confirmation",
	"confirm_body": "Thank you for signing up at white[ ]space.\nPlease click on the following link to confirm your email address.\n",
	"confirm_action": "Confirm Now",
	"team_invite_membership_subject": "Team Invitation for %s",
	"team_invite_membership_body": "You have been invited to %s on white[ ]space. Please click on the following link to accept the invitation.",
	"team_invite_user_body": "You have been invited to %s on white[ ]space.\nYour temporary password is \"%s\".\nPlease click on the following link to accept the invitation.",
	...
	"team_new_member_body": "%s just joined Team %s on white[ ]space.",
	"space_invite_membership_subject": "%s invited you to a Space %s ",
	"space_invite_membership_body": "You have been invited by %s to join a Space %s on white[ ]space. Please click on the following link to accept the invitation.",
	"space_invite_membership_action": "Accept",
	"folder_invite_membership_subject": "Space",
	"folder_invite_membership_body": "You have been invited to a Team on white[ ]space. Please click on the following link to accept the invitation.",
	...
	"white[ ]space_pro_ad_folders": "With white[ ]space Pro, you can organize an unlimited amount of Spaces in Folders and manage access controls for each Folder. Would you like to learn more about Pro features?",
	"white[ ]space_pro_ad_versions": "With white[ ]space Pro, you can save unlimited versions of each Space to track your progress or keep snapshots safe. Would you like to learn more about Pro features?",
	"white[ ]space_pro_ad_pdf": "With white[ ]space Pro, you can export your Spaces as crisp PDFs for archiving, mailing around, or printing. Do you want to learn more about Pro features?",
	"white[ ]space_pro_ad_zip": "With white[ ]space Pro, you can export the contents of a Space as a ZIP package. Do you want to learn more about Pro features?",
	"white[ ]space_pro_ad_colors": "With white[ ]space Pro, you can mix your own colors using a professional color picker.",
	...
	"landing_claim": "white[ ]space lets you easily combine all kinds of media on virtual whiteboards: Text notes, photos, web links, even videos and audio recordings. ",
	"landing_example": "People use white[ ]space to organize their ideas, in teams to see whole projects at a glance, or in schools and universities for richer, connected learning experiences.",
	"spaces": "My Spaces",
	...
	"landing_features_text": "The new white[ ]space 5 has a streamlined, beautiful user interface that makes your work easier and more fun than ever before – while giving you even more powerful features:",
	...
	"welcome_subject": "Welcome to white[ ]space",
	"welcome_body": "Hello!\nThank you for signing up at white[ ]space.<br>We hope you will enjoy working in Spaces.<br>Remember, your account includes unlimited collaborators. Feel free to share your Spaces with friends and colleagues all over the world.",
	...
	"pro_ad_history_headline": "When you upgrade to white[ ]space Pro, you will see a history of recent updates across all your (shared) Spaces here.",
	"password_reset_subject": "Reset Password for white[ ]space",
	"password_reset_body": "You requested a reset of your white[ ]space password.\nPlease click on the following link to set a new password.",
	"password_reset_action": "Reset Now",
	"was_offline": "The connection to white[ ]space was interrupted. If you have unsaved work, please keep this browser tab open until the connection is re-established, then touch the unsaved objects again.",
	"subscription_failed_user_subject": "Problem with your white[ ]space Payment",
	...
	"subscription_failed_team_subject": "Problem with your white[ ]space Payment",
